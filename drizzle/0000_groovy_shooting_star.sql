...
CREATE INDEX "idx_auditoria_fecha" ON "auditoria" USING btree ("fecha" timestamp_ops);--> statement-breakpoint
...
CREATE INDEX "idx_stock_producto" ON "stock" USING btree ("id_producto" text_ops);