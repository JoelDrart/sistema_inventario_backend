...
export const compraDetalleRelations = relations(
  compraDetalle,
  ({ one, many }) => ({
    compra: one(compra, {
...
export const movimientoBodegaRelations = relations(
  movimientoBodega,
  ({ one }) => ({
    producto: one(producto, {
...
export const facturaDetalleRelations = relations(
  facturaDetalle,
  ({ one, many }) => ({
    factura: one(factura, {
...
export const devolucionDetalleRelations = relations(
  devolucionDetalle,
  ({ one }) => ({
...
export const devolucionProveedorRelations = relations(
  devolucionProveedor,
  ({ one, many }) => ({
    compra: one(compra, {
...
export const devolucionProveedorDetalleRelations = relations(
  devolucionProveedorDetalle,
  ({ one }) => ({
...
export const promocionProductoRelations = relations(
  promocionProducto,
  ({ one }) => ({
...
export const transaccionCajaRelations = relations(
  transaccionCaja,
  ({ one }) => ({
    caja: one(caja, {
